    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.TextField(blank=True,
                                   ...
                                   max_length=300, verbose_name='Миниверсия статьи'),
        ),
        migrations.AlterField(
            model_name='articlephotoreport',
            name='article',
            field=models.ForeignKey(help_text='К какой статье относится картинка',
                                    on_delete=django.db.models.deletion.CASCADE, related_name='photos',
